...
const navItems = [
  {
    ...
    subItems: [
      ...
      { name: "Doji", path: "/doji", pro: false },
      { name: "Bullish Kicker", path: "/bullish-kicker", pro: false },
      { name: "Bearish Kicker", path: "/bearish-kicker", pro: false },
      { name: "Pro Gap Positive", path: "/pro-gap-positive", pro: false },
      { name: "Pro Gap Negative", path: "/pro-gap-negative", pro: false },
    ],
