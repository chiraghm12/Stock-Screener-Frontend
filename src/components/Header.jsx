                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                        <div className="flex items-center gap-2 bg-slate-800/50 rounded-lg p-1.5 border border-slate-700/50">
                            {timeframes.map((tf) => (
                                <button
                                    ...
                                    disabled={tf !== '1D'}
                                    className={`px-4 py-2 rounded-md text-sm font-semibold transition-all ${tf === selectedTimeframe
                        ...
                        <Button
                            onClick={onRefresh}
                            disabled={isLoading}
                            className="bg-slate-700 hover:bg-slate-600 text-slate-100 font-semibold h-full"
                        >
                            <RefreshCw
